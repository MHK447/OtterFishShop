...
public struct UpgradeData : IFlatbufferObject
{
  ...
  public bool Isbuycheck { get { int o = __p.__offset(8); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public bool MutateIsbuycheck(bool isbuycheck) { int o = __p.__offset(8); if (o != 0) { __p.bb.Put(o + __p.bb_pos, (byte)(isbuycheck ? 1 : 0)); return true; } else { return false; } }
  ...
  public static void AddIsbuycheck(FlatBufferBuilder builder, bool isbuycheck) { builder.AddBool(2, isbuycheck, false); }
